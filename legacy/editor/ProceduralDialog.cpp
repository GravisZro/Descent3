...
CProceduralDialog::CProceduralDialog(CWnd* pParent /*=NULL*/)
	: CDialog(CProceduralDialog::IDD, pParent)
{
...
void CProceduralDialog::OnClearProcedurals() 
{
...
void CProceduralDialog::OnProceduralUpdate() 
{
	UpdateDialog();
}
...
void CProceduralDialog::OnCopyProcedural() 
{
	...
	bool do_pal =false;
	char buffer[512];
	sprintf(buffer,"Are you sure you want to replace the procedural elements of %s with %s?",GameTextures[D3EditState.texdlg_texture].name,GameTextures[src_id].name);
