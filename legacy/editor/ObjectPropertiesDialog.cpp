...
BOOL CObjectPropertiesDialog::Create(LPCTSTR lpszClassName, LPCTSTR lpszWindowName, DWORD dwStyle, const RECT& rect, CWnd* pParentWnd, UINT nID, CCreateContext* pContext) 
{
...
//	Display current tab dialog	
	...
	{
		case TAB_PHYSICS:	m_KeypadTabDialog = m_PropPhysicsDlg; break;
		case TAB_AI:		m_KeypadTabDialog = m_PropAIDlg; break;
		default: Int3();
	}
