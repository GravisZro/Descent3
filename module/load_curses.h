...
namespace curses
{
  CPPEXTERN bool load(void);
  CPPEXTERN bool unload(void);
  ...
  extern int (STDCALL *attroff) (NCURSES_ATTR_T);
  extern int (STDCALL *attron) (NCURSES_ATTR_T);
  extern int (STDCALL *attrset) (NCURSES_ATTR_T);
  extern int (STDCALL *attr_get) (attr_t*, NCURSES_PAIRS_T*, void*);
  extern int (STDCALL *attr_off) (attr_t, void*);
  extern int (STDCALL *attr_on) (attr_t, void*);
  extern int (STDCALL *attr_set) (attr_t, NCURSES_PAIRS_T, void*);
  ...
  extern int (STDCALL *chgat) (int, attr_t, NCURSES_PAIRS_T, const void*);
  ...
  extern int (STDCALL *color_content) (NCURSES_COLOR_T,NCURSES_COLOR_T*,NCURSES_COLOR_T*,NCURSES_COLOR_T*);
  extern int (STDCALL *color_set) (NCURSES_PAIRS_T,void*);
  ...
  extern int (STDCALL *init_color) (NCURSES_COLOR_T,NCURSES_COLOR_T,NCURSES_COLOR_T,NCURSES_COLOR_T);
  extern int (STDCALL *init_pair) (NCURSES_PAIRS_T,NCURSES_COLOR_T,NCURSES_COLOR_T);
  ...
  extern NCURSES_CONST char* (STDCALL *keyname) (int);
  ...
  extern int (STDCALL *mvchgat) (int, int, int, attr_t, NCURSES_PAIRS_T, const void*);
  ...
  extern int (STDCALL *mvwchgat) (WINDOW*, int, int, int, attr_t, NCURSES_PAIRS_T, const void*);
  ...
  extern int (STDCALL *pair_content) (NCURSES_PAIRS_T,NCURSES_COLOR_T*,NCURSES_COLOR_T*);
  ...
  extern int (STDCALL *slk_attr_set) (const attr_t,NCURSES_PAIRS_T,void*);
  extern int (STDCALL *slk_clear) (void);
  extern int (STDCALL *slk_color) (NCURSES_PAIRS_T);
  ...
  extern int (STDCALL *vidputs) (chtype, NCURSES_OUTC);
  ...
  extern int (STDCALL *wattr_get) (WINDOW*, attr_t*, NCURSES_PAIRS_T*, void*);
  extern int (STDCALL *wattr_on) (WINDOW*, attr_t, void*);
  extern int (STDCALL *wattr_off) (WINDOW*, attr_t, void*);
  extern int (STDCALL *wattr_set) (WINDOW*, attr_t, NCURSES_PAIRS_T, void*);
  ...
  extern int (STDCALL *wchgat) (WINDOW*, int, attr_t, NCURSES_PAIRS_T, const void*);
  extern int (STDCALL *wclear) (WINDOW*);
  extern int (STDCALL *wclrtobot) (WINDOW*);
  extern int (STDCALL *wclrtoeol) (WINDOW*);
  extern int (STDCALL *wcolor_set) (WINDOW*,NCURSES_PAIRS_T,void*);
