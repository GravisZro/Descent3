...
#define ID_CUSTOM_OBJECT_0827 0x001
...
const char *Object_names[NUM_OBJECT_NAMES] = {"Finish Level"};
...
char STDCALL InitializeDLL(tOSIRISModuleInit *func_list) {
  ...
  if (func_list->script_identifier != NULL) {
    ...
    strcpy(filename, "myPowerHouse.msg");
...
int STDCALL GetCOScriptList(int **list, int **id_list) {
  ...
  static int cust_id_list[1] = {ID_CUSTOM_OBJECT_0827};
