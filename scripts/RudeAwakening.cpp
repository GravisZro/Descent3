...
char *Door_names[NUM_DOOR_NAMES] = {"DoorH", "DoorG", "DoorF", "DoorE", "DoorD", "DoorC", "DoorB", "DoorA"};
int Door_handles[NUM_DOOR_NAMES];

#define NUM_OBJECT_NAMES 15
char *Object_names[NUM_OBJECT_NAMES] = {"SwitchH",     "SwitchG",      "SwitchF",      "SwitchE",      "SwitchD",
...
char *Sound_names[NUM_SOUND_NAMES] = {"AmbSwitch21", "AmbSwitch11", "AmbDroneN", "AmbDroneL", "AmbDroneK"};
...
short CustomObjectScript_101A::CallEvent(int event, tOSIRISEventInfo *data) {
  switch (event) {
  case EVT_COLLIDE: {
    tOSIRISEVTCOLLIDE *event_data = &data->evt_collide;
...
short CustomObjectScript_1018::CallEvent(int event, tOSIRISEventInfo *data) {
  switch (event) {
  case EVT_COLLIDE: {
    tOSIRISEVTCOLLIDE *event_data = &data->evt_collide;
...
short CustomObjectScript_1813::CallEvent(int event, tOSIRISEventInfo *data) {
  switch (event) {
  case EVT_COLLIDE: {
    tOSIRISEVTCOLLIDE *event_data = &data->evt_collide;
...
short CustomObjectScript_1014::CallEvent(int event, tOSIRISEventInfo *data) {
  switch (event) {
  case EVT_COLLIDE: {
    tOSIRISEVTCOLLIDE *event_data = &data->evt_collide;
