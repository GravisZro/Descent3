...
const char *Object_names[NUM_OBJECT_NAMES] = {"Swamp", "Forest"};
...
const char *Sound_names[NUM_SOUND_NAMES] = {"AmbIslandFroggies", "AmbBugsGroundB"};
...
char STDCALL InitializeDLL(tOSIRISModuleInit *func_list) {
  ...
  if (func_list->script_identifier != NULL) {
    ...
    strcpy(filename, "BathroomJungle.msg");
