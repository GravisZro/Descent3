...
char *Door_names[NUM_DOOR_NAMES] = {"BossDoor", "CollectorsDoor", "BuildersDoor", "PriestHallDoor",
                                    "PriestGalleryDoor"};
int Door_handles[NUM_DOOR_NAMES];

#define NUM_OBJECT_NAMES 39
char *Object_names[NUM_OBJECT_NAMES] = {"DummyFlag",
                                        "BossMovieCollider",
                                        "BossRock01",
                                        "BossRock02",
                                        "BossRock03",
...
char *Room_names[NUM_ROOM_NAMES] = {"EndWindyRoom",     "PriestPedestal",  "CollectorsPedestal",
...
char *Trigger_names[NUM_TRIGGER_NAMES] = {"MusicCommon2Coll",
                                          "MusicCommon2Build",
                                          "WaypointInBuilders",
                                          "BuildersHalfWay",
                                          "MusicUseKeys2Priest",
...
char *Sound_names[NUM_SOUND_NAMES] = {"Powerup pickup", "DoorIsLocked",           "expMissileTearing1",
                                      "AmbBigUnlock",   "You don't have it BEEP", "Lev5Goal",
                                      "Lev5GoalFail",   "DefaultBuildingExplode"};
int Sound_indexes[NUM_SOUND_NAMES];

#define NUM_TEXTURE_NAMES 1
char *Texture_names[NUM_TEXTURE_NAMES] = {"FunkyEffect1"};
...
char *Matcen_names[NUM_MATCEN_NAMES] = {"Boss Room Matcen 1", "Boss Room Matcen 2", "NomadMainRoom1", "NomadPriestHall",
                                        "NomadPriestGallery"};
int Matcen_indexes[NUM_MATCEN_NAMES];

#define NUM_GOAL_NAMES 7
char *Goal_names[NUM_GOAL_NAMES] = {"Find the Builders' Icon", "Find the Priest's Icon", "Find the Collectors' Icon",
                                    "Use the icons",           "Use the Priest's Icon",  "Find the crashed CED ship",
                                    "Enter the Nomad Caverns"};
int Goal_indexes[NUM_GOAL_NAMES];

#define NUM_MESSAGE_NAMES 38
char *Message_names[NUM_MESSAGE_NAMES] = {"FirstPickupBuilder",
                                          "FirstPickupPriest",
...
short CustomObjectScript_208F::CallEvent(int event, tOSIRISEventInfo *data) {
  switch (event) {
  case EVT_COLLIDE: {
...
short CustomObjectScript_20BE::CallEvent(int event, tOSIRISEventInfo *data) {
  switch (event) {
  case EVT_COLLIDE: {
    tOSIRISEVTCOLLIDE *event_data = &data->evt_collide;
...
short CustomObjectScript_206F::CallEvent(int event, tOSIRISEventInfo *data) {
  switch (event) {
  case EVT_COLLIDE: {
    tOSIRISEVTCOLLIDE *event_data = &data->evt_collide;
...
short CustomObjectScript_10A5::CallEvent(int event, tOSIRISEventInfo *data) {
  switch (event) {
  case EVT_COLLIDE: {
    tOSIRISEVTCOLLIDE *event_data = &data->evt_collide;
...
short CustomObjectScript_081D::CallEvent(int event, tOSIRISEventInfo *data) {
  switch (event) {
  case EVT_COLLIDE: {
    tOSIRISEVTCOLLIDE *event_data = &data->evt_collide;
...
short CustomObjectScript_081E::CallEvent(int event, tOSIRISEventInfo *data) {
  switch (event) {
  case EVT_COLLIDE: {
    tOSIRISEVTCOLLIDE *event_data = &data->evt_collide;
...
short CustomObjectScript_081C::CallEvent(int event, tOSIRISEventInfo *data) {
  switch (event) {
  case EVT_COLLIDE: {
    tOSIRISEVTCOLLIDE *event_data = &data->evt_collide;
...
short CustomObjectScript_10C7::CallEvent(int event, tOSIRISEventInfo *data) {
  switch (event) {
  case EVT_DESTROY: {
...
short CustomObjectScript_18B9::CallEvent(int event, tOSIRISEventInfo *data) {
  switch (event) {
  case EVT_DESTROY: {
    tOSIRISEVTDESTROY *event_data = &data->evt_destroy;
...
short CustomObjectScript_2051::CallEvent(int event, tOSIRISEventInfo *data) {
  switch (event) {
  case EVT_COLLIDE: {
    tOSIRISEVTCOLLIDE *event_data = &data->evt_collide;
...
short CustomObjectScript_180A::CallEvent(int event, tOSIRISEventInfo *data) {
  switch (event) {
  case EVT_COLLIDE: {
    tOSIRISEVTCOLLIDE *event_data = &data->evt_collide;
...
short CustomObjectScript_216E::CallEvent(int event, tOSIRISEventInfo *data) {
  switch (event) {
  case EVT_INTERVAL: {
    tOSIRISEVTINTERVAL *event_data = &data->evt_interval;
...
short CustomObjectScript_3167::CallEvent(int event, tOSIRISEventInfo *data) {
  switch (event) {
  case EVT_INTERVAL: {
    tOSIRISEVTINTERVAL *event_data = &data->evt_interval;
...
short CustomObjectScript_1964::CallEvent(int event, tOSIRISEventInfo *data) {
  switch (event) {
  case EVT_INTERVAL: {
    tOSIRISEVTINTERVAL *event_data = &data->evt_interval;
...
short CustomObjectScript_316A::CallEvent(int event, tOSIRISEventInfo *data) {
  switch (event) {
  case EVT_INTERVAL: {
    tOSIRISEVTINTERVAL *event_data = &data->evt_interval;
