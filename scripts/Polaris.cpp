...
class CustomObjectScript_303F : public BaseScript {
public:
  int16_t CallEvent(int event, tOSIRISEventInfo *data);
};
...
const char *Object_names[NUM_OBJECT_NAMES] = {"Spewer", "MagnetBeam"};
int Object_handles[NUM_OBJECT_NAMES];

#define NUM_ROOM_NAMES 2
const char *Room_names[NUM_ROOM_NAMES] = {"BluePipe", "RedPipe"};
int Room_indexes[NUM_ROOM_NAMES];

#define NUM_TRIGGER_NAMES 4
const char *Trigger_names[NUM_TRIGGER_NAMES] = {"RedOut", "RedIn", "BlueOUt", "BlueIn"};
int Trigger_indexes[NUM_TRIGGER_NAMES];
int Trigger_faces[NUM_TRIGGER_NAMES];
int Trigger_rooms[NUM_TRIGGER_NAMES];

#define NUM_SOUND_NAMES 1
const char *Sound_names[NUM_SOUND_NAMES] = {"LevSecAccelStart"};
...
const char *Message_names[NUM_MESSAGE_NAMES] = {"Polar"};
...
void STDCALLPTR CreateInstance(int id) {
  ...
  case ID_LEVEL_0000:
    ...
    break;
  case ID_CUSTOM_OBJECT_303F:
    return new CustomObjectScript_303F;
    break;
...
void STDCALL DestroyInstance(int id, void *ptr) {
  ...
  case ID_LEVEL_0000:
    ...
    break;
  case ID_CUSTOM_OBJECT_303F:
    delete ((CustomObjectScript_303F *)ptr);
    break;
  case ID_TRIGGER_0000:
...
int STDCALL GetCOScriptList(int **list, int **id_list) {
  ...
  static int cust_id_list[1] = {ID_CUSTOM_OBJECT_303F};
...
int16_t LevelScript_0000::CallEvent(int event, tOSIRISEventInfo *data) {
  ...
  case EVT_LEVELSTART: {
    ...
    // Script 000: LevelStart
    if ((ScriptActionCtr_000 < 1) && (1)) {
      aUserFlagSet(0, 1);
      aTurnOnSpew(Object_handles[0], -1, 7, 0.000000f, 0.000000f, 65536, 0, 1.400000f, 0.130000f, -1.000000f, 3.700000f,
                  30.000000f, 0, -1);
      aRoomSetWind(Room_indexes[0], 0.000000f, 0.000000f, -15.000000f, 1.000000f);
      aRoomSetWind(Room_indexes[1], 0.000000f, 0.000000f, 15.000000f, 1.000000f);
...
int16_t CustomObjectScript_303F::CallEvent(int event, tOSIRISEventInfo *data) {
  switch (event) {
  case EVT_COLLIDE: {
    tOSIRISEVTCOLLIDE *event_data = &data->evt_collide;

    // Script 001: RunIntoMe!
    if (qObjIsPlayer(event_data->it_handle) == true) {
      ...
      if (qUserFlag(0) == true) {
        aUserFlagSet(0, 0);
        aRoomChangeWind(Room_indexes[0], 0.000000f, 0.000000f, 15.000000f, 1.000000f, 4.000000f);
        aRoomChangeWind(Room_indexes[1], 0.000000f, 0.000000f, -15.000000f, 1.000000f, 4.000000f);
      } else {
        aUserFlagSet(0, 1);
        aRoomChangeWind(Room_indexes[1], 0.000000f, 0.000000f, 15.000000f, 1.000000f, 4.000000f);
        aRoomChangeWind(Room_indexes[0], 0.000000f, 0.000000f, -15.000000f, 1.000000f, 4.000000f);
