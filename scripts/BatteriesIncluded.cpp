...
char *Object_names[NUM_OBJECT_NAMES] = {"BurningCoffee"};
int Object_handles[NUM_OBJECT_NAMES];

#define NUM_ROOM_NAMES 6
char *Room_names[NUM_ROOM_NAMES] = {"MensIntake",  "LessIntake",   "LessConnect",
...
char *Sound_names[NUM_SOUND_NAMES] = {"HudMessage", "WeaponHitWater"};
...
char *Message_names[NUM_MESSAGE_NAMES] = {"Chris", "Kevin", "JeffNate", "Matt",  "Jay",      "Jerry",
