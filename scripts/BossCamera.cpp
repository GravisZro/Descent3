...
char *Object_names[NUM_OBJECT_NAMES] = {"Boss"};
...
char *Trigger_names[NUM_TRIGGER_NAMES] = {"EnterBigRoom"};
...
char *Path_names[NUM_PATH_NAMES] = {"BossPath"};
...
char *Message_names[NUM_MESSAGE_NAMES] = {"Message2"};
