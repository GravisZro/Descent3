...
const char *Object_names[NUM_OBJECT_NAMES] = {"Boss"};
...
const char *Trigger_names[NUM_TRIGGER_NAMES] = {"EnterBigRoom"};
...
const char *Path_names[NUM_PATH_NAMES] = {"BossPath"};
...
const char *Message_names[NUM_MESSAGE_NAMES] = {"Message2"};
