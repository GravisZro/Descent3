...
// ========================================
void ClearGlobalActionCtrs(void) { ScriptActionCtr_000 = 0; }

// ========================================
// Function to Save Global Action Counters
// ========================================
void SaveGlobalActionCtrs(void *file_ptr) { File_WriteInt(ScriptActionCtr_000, file_ptr); }

// ===========================================
// Function to Restore Global Action Counters
// ===========================================
void RestoreGlobalActionCtrs(void *file_ptr) { ScriptActionCtr_000 = File_ReadInt(file_ptr); }
...
int16_t LevelScript_0000::CallEvent(int event, tOSIRISEventInfo *data) {
  ...
  case EVT_LEVELSTART: {
    ...
    // Script 000: Wind!
    if (1) {
      aRoomSetWind(Room_indexes[0], 0.000000f, 10.000000f, 0.000000f, 1.000000f);
      aRoomSetWind(Room_indexes[1], 0.000000f, -10.000000f, 0.000000f, 1.000000f);
      aRoomSetWind(Room_indexes[2], 0.000000f, -10.000000f, 0.000000f, 1.000000f);
      aRoomSetWind(Room_indexes[3], 0.000000f, 10.000000f, 0.000000f, 1.000000f);
